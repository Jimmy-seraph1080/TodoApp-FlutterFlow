  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      final user = await authManager.signInWithEmail(
        context,
        _model.loginSTextController.text,
    ...
    _model.loginSTextController ??= TextEditingController();
    _model.loginSFocusNode ??= FocusNode();
                                ...
                                Column(
                                  ...
                                  children: [
                                    SizedBox(
                                      width: 400.0,
                                      child: TextFormField(
                                        controller: _model.loginSTextController,
                                        focusNode: _model.loginSFocusNode,
                                        onChanged: (_) => EasyDebounce.debounce(
                                          '_model.loginSTextController',
                                          const Duration(milliseconds: 2000),
                                          () => safeSetState(() {}),
                                        ),
                                        autofocus: false,
